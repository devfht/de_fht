...
window.SITE_CONTENT = {
  ...
  "hero": {
    ...
    "role": "Builder & level designer — 3 ans sur Roblox · Build · GUI · GFX",
    "bio": "Builder français avec 3 ans d'expérience sur Roblox, solides bases en GUI Design et GFX. La précision dans chaque détail, l'immersion à chaque instant, et la performance comme standard.",
    "ctaPrimary": "Demander un devis",
    "ctaSecondary": "Voir les builds"
  },
  "social": {
    "discord": "de_fht",
  ...
  "footer": {
    "online": true,
    "status": "Dispo pour commissions — Discord de_fht"
  }
};
